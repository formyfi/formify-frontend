...
const getAllTaskLists = createAsyncThunk(
  "get_tasklists_all",
  async (values) => {
...
const getTemplates = createAsyncThunk("get_templates", async (values) => {
  const response = await apis
    .getTemplates(values)
    .then((response) => {
      if (response.status === 200) {
...
const getTaskForm = createAsyncThunk("get_task_form", async (values) => {
  const response = await apis
    .getTaskForm(values)
    .then((response) => {
      if (response.status === 200) {
...
const updateTaskForm = createAsyncThunk("update_task_form", async (values) => {
  const response = await apis
...
const deleteChecklist = createAsyncThunk("deleteAction", async (values) => {
  const response = await apis
...
const getFormTimeLine = createAsyncThunk("getFormTimeLine", async (values) => {
  const response = await apis
...
const setFormTimeLine = createAsyncThunk("setFormTimeLine", async (values) => {
  const response = await apis
